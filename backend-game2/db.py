...
CREATE_TABLE_SQL = """
CREATE TABLE IF NOT EXISTS bidmasters (
...
CREATE OR REPLACE FUNCTION notify_simulation_update()
RETURNS TRIGGER AS $$
BEGIN
    PERFORM pg_notify('simulation_channel', 'updated');
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
"""
...
CREATE_TRIGGER_SQL = """
CREATE TRIGGER simulation_update_trigger
